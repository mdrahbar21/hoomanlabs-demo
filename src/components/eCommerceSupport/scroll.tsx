  ...
  return (
    <section className="h-[100vh]">
        <div className="grid grid-cols-7 gap-10 max-w-[1440px] mx-auto ">
            <div className="col-span-3 bg-gradient-to-b from-[#A37C5B]/5 to-[#3D2E22]/5 flex items-center justify-center">
                <div ref={ref}>
                    <div className="flex ">
            ...
            <motion.div className="col-span-4 flex flex-col ml-12" style={{ y }}>
                <div className="h-12 w-12">
                    <img src={section.icon} className="" alt="" />
                </div>
                <div className="mt-10">
                    {section.title}
                    <ul className="list-disc text- mt-20 ml-8">
  ...
  return (
    ...
    <div className="sm:mx-4 border border-[#F80759] flex items-center justify-center rounded-full py-1 px-2 sm:px-3 mb-6 w-fit bg-[#AA093F]/10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 w-full max-w-[1440px] gap-10 mx-auto py-10">
        <h2 className="md:text-start md:col-span-2 text-center mb-36">
