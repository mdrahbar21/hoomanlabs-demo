            ...
            <div className="grid grid-cols-1 md:grid-cols-2 w-full h-screen max-w-[1440px] gap-10 mx-auto py-10 mt-10">
                ...
                <div className="col-span-1 ">
                        {/* <div className='border'>
                            <div className="font-Gilroy flex flex-col items-center justify-center w-[80vw] max-w-[400px] mx-auto pt-10 gap-6">
                                ...
                                >
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="text" className="block text-gray-700 text-sm font-bold mb-2">Message:</label>
                                        <textarea
                                            id="text"
